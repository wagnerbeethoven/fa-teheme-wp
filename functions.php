...
Configurar o Customizer do WordPress
function customizar_rodape($wp_customize) {
  $wp_customize->add_section('rodape', array(
      'title' => __('Rodapé'),
      'description' => __('Configurações do rodapé do site'),
  ));
  ...
  $wp_customize->add_control('logo_alt', array(
      'label' => __('Texto Alternativo da Logo'),
      'section' => 'rodape',
      'type' => 'text',
  ));
}
...
function customizar_plataformas($wp_customize) {
  $wp_customize->add_setting('platforms_links', array(
  ...
  $wp_customize->add_control(new WP_Customize_Control(
      ...
      'platforms_links',
      array(
          'label' => __('Links das Plataformas'),
          'section' => 'rodape',
          'type' => 'textarea',
          'description' => 'Adicione os links das plataformas em formato JSON: [{"name": "Plataforma", "url": "https://link.com"}]',
      )
  ));
}
add_action('customize_register', 'customizar_plataformas');



function carregar_estilos_e_scripts() {
  wp_enqueue_style('estilo-tema', get_template_directory_uri() . '/main.css');
  wp_enqueue_script('script-tema', get_template_directory_uri() . '/main.js', array(), null, true);
}
add_action('wp_enqueue_scripts', 'carregar_estilos_e_scripts');*/



// Inclui as configurações do tema
